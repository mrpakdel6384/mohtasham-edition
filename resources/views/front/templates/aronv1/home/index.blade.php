...
<section class="jarallax bg-dark py-7" data-jarallax data-speed="0.25">
    <div class="jarallax-img" style="background-image: url({{asset('/front/around/img/home09-banner-img02.jpeg')}});"></div>
    ...
    <div class="masonry-filterable mb-3">
        ...
        <ul class="masonry-filters nav nav-tabs justify-content-center pb-4 d-rtl">
            ...
            @foreach($categoryPortfolios as $categoryPortfolio)
                <li class="nav-item"><a class="nav-link" href="#" data-group="{{$categoryPortfolio->slug}}">{{$categoryPortfolio->name}}</a></li>
            @endforeach
        </ul>
        <!-- Portfolio grid-->
        <div class="masonry-grid" data-columns="3">
            @foreach($categoryPortfolios as $categoryPortfolio)
                @foreach($categoryPortfolio->portfolios->unique('id')->take(2) as $portfolio)
                <div class="masonry-grid-item" data-groups="[&quot;{{$portfolio->categories[0]->slug}}&quot;]">
                    <a class="card card-hover border-0 shadow" href="#">
                        <img class="card-img-top" src="{{$portfolio->image}}" alt="Portfolio thumb">
                        <div class="card-body text-center">
                            <h3 class="h5 nav-heading mb-2">{{$portfolio->title}}</h3>
