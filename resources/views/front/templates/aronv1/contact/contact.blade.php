...
<section class="position-relative bg-gradient " style="height: 590px;">
      ...
      <section class="container position-relative zindex-5 pt-7 d-rtl" style="margin-top: -590px;">
        <div class="row pt-md-4 pt-lg-5 mt-3">
          <div class="col-lg-4 col-md-5 offset-lg-1">
            ...
            <div class="d-flex align-items-start mb-4"><i class="ai-mail h3 mt-n1 mb-0 text-light"></i>
              <div class="pe-3"><a class="d-inline-block text-light text-decoration-none mb-2" href="mailto:contact@aron-soft.com">contact@aron-soft.com</a></div>
            </div>
            <div class="d-flex align-items-start mb-4"><i class="ai-phone h3 mt-n1 mb-0 text-light"></i>
              <div class="pe-3"><a class="d-inline-block text-light text-decoration-none mb-2" href="tel:+982122451912">021-22451912</a></div>
            </div>
          </div>
