                        ...
                        <form class="needs-validation" action="{{route('login')}}" method="post">
                            ...
                            <div class="mb-3">
                                <div class="input-group">
                                    ...
                                    <input class="form-control rounded" type="email" placeholder="آدرس ایمیل" required>
                                </div>
                            </div>
                            <div class="mb-3">
                                <div class="input-group">
                ...
                <div class="view" id="modal-signup-view">
                    ...
                    <div class="modal-body px-4">
                        ...
                        <form class="needs-validation" novalidate>
                            ...
                            <div class="mb-3">
                                <input class="form-control" type="text" placeholder="ایمیل" required>
                            </div>
                            <div class="mb-3 password-toggle">
                                <input class="form-control" type="password" placeholder="رمزعبور" required>
                                <label class="password-toggle-btn" aria-label="Show/hide password">
                                    <input class="password-toggle-check" type="checkbox"><span class="password-toggle-indicator"></span>
                                </label>
                            </div>
                            <div class="mb-3 password-toggle">
                                <input class="form-control" type="password" placeholder="تکرار رمز عبور" required>
                                <label class="password-toggle-btn" aria-label="Show/hide password">
                                    <input class="password-toggle-check" type="checkbox"><span class="password-toggle-indicator"></span>
                                </label>
                            </div>
