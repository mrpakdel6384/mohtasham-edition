@component('front.templates.aron.layouts.contents')
    <section class="parallax py-7">
        ...
        <div class="parallax-container">
            <div class="parallax-img" style="    background-image: url({{asset('/front/aron/images/home09-banner-img02.jpeg')}});
    object-fit: cover;
...
<!--PORTFOLIO-->
    <section class="container overflow-hidden pt-5 pt-md-6 pt-lg-7 pb-4 pb-md-2">
        ...
        <p class="text-center text-muted pb-4">جدیدترین پروژه های تکمیل شده Aron</p>
        <div class="row">
    ...
    @slot('script')
        <script src="{{asset('/front/aron/js/isotope.pkgd.min.js')}}"></script>
        <script src="{{asset('/front/aron/plugins/owlcarousel/owl.carousel.js')}}"></script>
        <script>
    ...
    @slot('topcss')
        <!-- Owl Stylesheets -->
        <link rel="stylesheet" href="{{asset('/front/aron/plugins/owlcarousel/assets/owl.carousel.min.css')}}">
        <link rel="stylesheet" href="{{asset('/front/aron/plugins/owlcarousel/assets/owl.theme.default.min.css')}}">
    @endslot
@endcomponent
