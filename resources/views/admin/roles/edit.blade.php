                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">فرم های ویرایش مقام</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="{{route('admin.roles.update' , ['role'=>$role->id])}}" method="post" class="form-horizontal">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <div class="">
                                        <input type="text" name="name" class="form-control" id="name" placeholder="عنوان مقام را وارد کنید" value="{{old('name' , $role->name)}}">
                                    </div>
                                </div>
                                <div class="form-group">
