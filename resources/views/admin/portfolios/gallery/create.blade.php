@component('admin.layouts.content' , ['title' => 'ایجاد تصویر'])
    @slot('breadcrumb')
        ...
        <li class="breadcrumb-item"><a href="{{route('admin.portfolios.gallery.index' ,['portfolio'=>$portfolio->id])}}">{{ $portfolio->title }}</a></li>
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form class="form-horizontal" action="{{ route('admin.portfolios.gallery.store' , ['portfolio' => $portfolio->id]) }}" method="POST">
                    @csrf
