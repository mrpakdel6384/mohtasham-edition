@component('admin.layouts.content' , ['title' => 'ویرایش تصویر'])
    @slot('breadcrumb')
        ...
        <li class="breadcrumb-item"><a href="{{route('admin.portfolios.gallery.index' , $portfolio->id)}}">{{ $portfolio->title }}</a></li>
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form class="form-horizontal" action="{{ route('admin.portfolios.gallery.update' , ['portfolio' => $portfolio->id, 'gallery' => $gallery->id ]) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('patch')
...
{{--                        <hr>--}}
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ route('admin.portfolios.gallery.index' , ['portfolio' => $portfolio->id]) }}" class="btn btn-default float-left">لغو</a>
                    </div>
                    <!-- /.card-footer -->
                </form>
            </div>
