@component('admin.layouts.content' , ['title' => 'ایجاد دسته بندی'])
    @slot('breadcrumb')
        ...
        <li class="breadcrumb-item"><a href="{{ route('admin.categoriesservice.index') }}">لیست دسته بندی ها</a></li>
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form class="form-horizontal" action="{{ route('admin.categoriesservice.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
