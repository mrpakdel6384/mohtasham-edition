@component('admin.layouts.content' , ['title' => 'ایجاد خدمات'])
    @slot('breadcrumb')
        <li class="breadcrumb-item"><a href="/admin">پنل مدیریت</a></li>
        <li class="breadcrumb-item"><a href="{{ route('admin.services.index') }}">لیست خدمات</a></li>
        <li class="breadcrumb-item active">ایجاد خدمات</li>
    @endslot
            ...
            <div class="card">
                ...
                <form class="form-horizontal" action="{{ route('admin.services.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ route('admin.services.index') }}" class="btn btn-default float-left">لغو</a>
                    </div>
                    <!-- /.card-footer -->
                </form>
            </div>
