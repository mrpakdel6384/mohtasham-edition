@component('admin.layouts.content' , ['title' => 'ایجاد دسته بندی ماژول ها'])
    @slot('breadcrumb')
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form class="form-horizontal" action="{{ route('admin.categoriesmodule.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
