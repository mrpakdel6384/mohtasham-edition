            ...
            <div class="card">
                ...
                <form class="form-horizontal" action="{{ route('admin.products.update' , $product->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <img src="{{$product->image}}" alt="" class="img-responsive img-fluid" width="300px" height="auto">
                        </div>
                        <div class="form-group">
                            <label for="inputEmail3" class="col-sm-2 control-label">دسته بندی ها</label>
                            <select class="form-control" name="category_product_id[]" id="categories" multiple>
