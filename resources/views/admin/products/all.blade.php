                    ...
                    <table class="table table-hover">
                        ...
                        <tr>
                            ...
                            <td class="d-flex">
                                ...
                                @endcan
                                @can('create-image-product')
                                        <a href="{{route('admin.products.gallery.index', ['product'=>$product->id])}}" class="btn btn-sm btn-warning mr-2">گالری تصاویر <span class="badge badge-light">{{$product->gallery()->count()}}</span></a>
                                @endcan
