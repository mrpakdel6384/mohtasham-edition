...
class CategoryPortfolioController extends Controller
{
    ...
    public function index(CategoryPortfolio $category)
    {
        ...
        return view('front.templates.mohtasham.categoryportfolio.blog' , compact('category','projects','categories'));
    }
    ...
    public function service(CategoryPortfolio $category)
    {
        ...
        return view('front.templates.mohtasham.categoryportfolio.service',compact( 'category','portfolios'));
    }
}
